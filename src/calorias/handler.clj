...
(defroutes app-routes
  ...
  (GET "/exercicios/propostos" [] (como-json {:exercicios (db/exibir-possiveis-exercicios)}))
  ...
  (POST "/exercicios" requisicao (-> (exercicios/registrar-exercicio (:body requisicao))
                                     (como-json 201)))
  (POST "/exercicios/propostos" requisicao (-> (exercicios/registrar-cinco-exercicios (:body requisicao))
                                               (como-json 201)))
